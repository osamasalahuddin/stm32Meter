...
void TM_ILI9341_Draw_Bluetooth(uint16_t x, uint16_t y, TM_FontDef_t *font, uint32_t foreground, uint32_t background) {
	uint32_t i, b, j;
	char c = '~';
	/* Set coordinates */
	ILI9341_x = x;
	...
	/* Draw font data */
	for (i = 0; i < font->FontHeight; i++) {
		b = font->data[(c - 32 + 1) * font->FontHeight + i];
		for (j = 0; j < font->FontWidth; j++) {
			if ((b << j) & 0x8000) {
				TM_ILI9341_DrawPixel(ILI9341_x + j, (ILI9341_y + i), foreground);
			}
...
void TM_ILI9341_Draw_RightArrow(uint16_t x, uint16_t y, uint32_t foreground, uint32_t background) {
	uint32_t i, b, j;
	TM_FontDef_t *font = &RightArrow_Font_16x14;
	/* Set coordinates */
	ILI9341_x = x;
	ILI9341_y = y;
	...
	/* Draw font data */
	for (i = 0; i < font->FontHeight; i++) {
		b = font->data[0 * font->FontHeight + i];
		for (j = 0; j < font->FontWidth; j++) {
			if ((b << j) & 0x8000) {
				TM_ILI9341_DrawPixel(ILI9341_x + j, (ILI9341_y + i), foreground);
			}
...
void TM_ILI9341_Draw_LeftArrow(uint16_t x, uint16_t y, uint32_t foreground, uint32_t background) {
	uint32_t i, b, j;
	TM_FontDef_t *font = &LeftArrow_Font_16x14;
	/* Set coordinates */
	ILI9341_x = x;
	ILI9341_y = y;
...
void TM_ILI9341_Draw_Headlight(uint16_t x, uint16_t y, uint32_t foreground, uint32_t background) {
	uint32_t i, b, j;
	TM_FontDef_t *font = &Headlight_Font_16x14;
	/* Set coordinates */
	ILI9341_x = x;
	ILI9341_y = y;
...
void TM_ILI9341_Draw_Fuel(uint16_t x, uint16_t y, uint16_t percentage, uint32_t foreground, uint32_t background) {
	uint32_t i, b, j;
	TM_FontDef_t *font = &Fuel_Font_16x14;
	uint16_t c = percentage/10;
	/* Set coordinates */
	ILI9341_x = x;
	ILI9341_y = y;
	...
	/* Draw font data */
	for (i = 0; i < font->FontHeight; i++) {
		b = font->data[c * font->FontHeight + i];
		for (j = 0; j < font->FontWidth; j++) {
			if ((b << j) & 0x8000) {
				TM_ILI9341_DrawPixel(ILI9341_x + j, (ILI9341_y + i), foreground);
			}
